...
class Config(object):
    ...
    # database config
    DB_NAME = os.environ.get("DB_NAME","ThejVwkHwjbsjsbwjs")     
    DB_URL  = os.environ.get("DB_URL","mongodb+srv://Telegram_Guy:I6AfG9KKBJ5397xF@botstore.t3cuf.mongodb.net/?retryWrites=true&w=majority&appName=Botstore")
...
"""
    ...
    ABOUT_TXT = """
<b>❍ ᴍʏ ɴᴀᴍᴇ : <a href='https://telegram.me/The_TGguy'>𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 𝗚𝘂𝘆!!</a>
❍ ʜᴏsᴛᴇᴅ ᴏɴ : ᴋᴏʏᴇʙ
❍ ᴅᴀᴛᴀʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ
❍ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ 𝟹
❍ ᴍʏ ᴄʀᴇᴀᴛᴏʀ : <a href='https://telegram.me/TGguy_Ownerobot'>◉⁠‿⁠◉</a>
